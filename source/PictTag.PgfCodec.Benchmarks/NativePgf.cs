...
/// <summary>
/// Minimal P/Invoke wrapper around the native <c>PictTagPgfDecoder</c> shim for this benchmark rig's
/// managed-vs-native comparisons (Stage 10, new-features/managed-pgf-codec.md) - re-declares the same
/// exports <c>PictTag.PgfCodec.Tests.Oracle.NativePgfOracle</c> does rather than referencing that test
